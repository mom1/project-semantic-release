...
class GithubCheckBuildStatusTests(TestCase):
    url = "https://api.github.com/repos/mom1/rmoq/commits/" "6dcb09b5b57875f334f61aebed695e2e4193db5e/status"
    ...
    def test_should_return_false_if_pending(self):
        ...
        self.assertFalse(Github.check_build_status("mom1", "rmoq", "6dcb09b5b57875f334f61aebed695e2e4193db5e"))
    ...
    def test_should_return_true_if_success(self):
        ...
        self.assertTrue(Github.check_build_status("mom1", "rmoq", "6dcb09b5b57875f334f61aebed695e2e4193db5e"))
...
class GithubReleaseTests(TestCase):
    url = "https://api.github.com/repos/mom1/rmoq/releases"
    edit_url = "https://api.github.com/repos/mom1/rmoq/releases/1"
    get_url = "https://api.github.com/repos/mom1/rmoq/releases/tags/v1.0.0"
    asset_url = "https://uploads.github.com/repos/mom1/rmoq/releases/1/assets"
    asset_url_params = (
        "https://uploads.github.com/repos/mom1/rmoq/releases/1/assets" "?name=testupload.md&label=Dummy+file"
    )
    asset_no_extension_url_params = (
        "https://uploads.github.com/repos/mom1/rmoq/releases/1/assets"
        "?name=testupload-no-extension&label=Dummy+file+no+extension"
    )
    dist_asset_url_params = "https://uploads.github.com/repos/mom1/rmoq/releases/1/assets" "?name=testupload.md"
    ...
    def test_should_post_changelog_using_github_token(self, mock_token):
        with NamedTemporaryFile("w") as netrc_file:
            ...
            with mock.patch.dict(os.environ, {"NETRC": netrc_file.name}):
                status = Github.post_release_changelog("mom1", "rmoq", "1.0.0", "text")
    ...
    def test_should_return_false_status_if_it_failed(self):
        ...
        self.assertFalse(Github.post_release_changelog("mom1", "rmoq", "1.0.0", "text"))
    ...
    def test_should_upload_asset(self, mock_token):
        ...
        responses.add_callback(responses.POST, self.asset_url, callback=request_callback)
        status = Github.upload_asset("mom1", "rmoq", 1, dummy_file_path, "Dummy file")
        self.assertTrue(status)
    ...
    def test_should_upload_asset_with_no_extension(self, mock_token):
        ...
        responses.add_callback(responses.POST, self.asset_url, callback=request_callback)
        status = Github.upload_asset("mom1", "rmoq", 1, dummy_file_path, "Dummy file no extension")
        self.assertTrue(status)
    ...
    def test_should_upload_dists(self, mock_token):
        ...
        responses.add_callback(responses.POST, self.asset_url, callback=request_callback)
        status = Github.upload_dists("mom1", "rmoq", "1.0.0", os.path.dirname(dummy_file_path))
        self.assertTrue(status)
